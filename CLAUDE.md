...
1. **Merge `action-instances-refactor` to main** (note: `state.db` reset required because the old-format action schemas won't parse as typed — pre-beta policy per `docs/THEME.md`-era stance).
